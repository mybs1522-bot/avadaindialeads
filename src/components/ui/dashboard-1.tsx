      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <Card className="h-full p-4 overflow-hidden rounded-xl">
            <CardContent className="p-2">
              <div className="flex items-center justify-between mb-4">
                <p className="font-medium text-muted-foreground">Design Hours</p>
              ...
              <div className="mb-4">
                ...
                <span className="ml-1 text-muted-foreground">hrs / student</span>
              </div>
              {/* Progress Bar */}
        ...
        >
          <Card className="h-full p-4 overflow-hidden rounded-xl bg-lime-50 dark:bg-lime-900/30 border-lime-200 dark:border-lime-800">
            <CardContent className="p-2">
              <div className="flex items-center justify-between mb-4">
                <p className="font-medium text-lime-900 dark:text-lime-200">Students</p>
              ...
              <div className="mb-6">
                ...
                <span className="ml-1 text-lime-800 dark:text-lime-300">worldwide</span>
              </div>
              {/* Avatar Stack */}
